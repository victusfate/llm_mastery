import { enhanceReadingLinks } from "./reader-links.mjs";
import {
  parseConcepts,
  findConcept,
  searchConcepts,
...
import { markdown, escapeHTML as esc } from "./engine.mjs";
...
export function startExplorer() {
  ...
  document.addEventListener("pointerup", (e) => {
    if (!e.target.closest?.("#selection-explain")) setTimeout(capture, 0);
  });
  ...
  document.addEventListener("dblclick", (e) => {
    if (
      e.target.closest?.("#main,#concept-body") &&
